<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditEmployees.aspx.cs" Inherits="Glamora.EditEmployees" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Glamora | Edit Employee</title>
    <meta charset="utf-8" />
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800&display=swap" rel="stylesheet" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />

    <style>
        /* --- Color Palette & Variables (Matching EditServices.aspx Dashboard) --- */
        :root {
        ...
        /* Style overrides for the Title dropdown and Contact input */
        .form-row > .form-group[style*="flex:0 0 140px;"] {
            flex: 0 0 140px !important; /* Keep Title column narrow */
        }
        
        .form-row > .form-group:not([style*="flex:0 0 140px;"]) {
             flex: 1 1 250px; /* Use default flex for other fields */
        }
        ...
        /* Style for the non-editable Employee ID label */
        .employee-id-value {
            font-weight: 500;
        ...
        .phone-textbox {
            flex: 1;
            /* Remove default phone-textbox border styles as they are now handled by form-group input styles */
    ...
    <form id="form1" runat="server">
        <div class="dashboard-wrapper">
            <div class="content-area">
                <h1 class="content-header">Edit Employee</h1>

                <div class="form-container">
                    <asp:Label ID="lblMsg" runat="server" Visible="false" CssClass="success-message"></asp:Label>

                    <%-- Employee ID (Non-editable display) --%>
                    <div class="form-group">
                        <label>Employee ID</label>
                        <asp:Label ID="lblEmpID" runat="server" Text="" CssClass="employee-id-value"></asp:Label>
                    </div>

                    <div class="form-row">
                        <%-- Title --%>
                        <div class="form-group" style="flex:0 0 140px;">
                            <asp:Label ID="lblTitleLabel" runat="server" AssociatedControlID="ddlTitle" Text="Title"></asp:Label>
                    ...
                    <div class="form-row" style="margin-top:10px;">
                        ...
                        <%-- Role --%>
                        <div class="form-group">
                            <asp:Label ID="lblRoleLabel" runat="server" AssociatedControlID="txtRole" Text="Role"></asp:Label>
                            <asp:TextBox ID="txtRole" runat="server" CssClass="form-input" MaxLength="50"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="rfvRole" runat="server" ControlToValidate="txtRole" ErrorMessage="Role is required." CssClass="error-message" Display="Dynamic"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <asp:Button ID="btnSave" runat="server" Text="Update Employee" OnClick="btnSave_Click" CssClass="btn-submit" />
                        <asp:HyperLink ID="hlBack" runat="server" NavigateUrl="Employees.aspx" CssClass="secondary-link">
