<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="Glamora.ResetPassword" %>
...
<head runat="server">
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .input-text { width:100%; padding:12px 40px 12px 12px; border:1px solid #cbd5e1; border-radius: var(--radius); font-size:1rem; }
        .input-text:focus { border-color: var(--primary-color); outline:none; box-shadow:0 0 0 3px rgba(99,102,241,0.18); }
        .toggle-eye { position:absolute; right:12px; background:none; border:none; cursor:pointer; color: var(--text-muted); font-size:1rem; padding:4px; }
        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <div class="password-wrap">
                    ...
                    <button type="button" class="toggle-eye" onclick="togglePassword('<%= txtPassword.ClientID %>', this)"><i class="fas fa-eye-slash"></i></button>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="password-wrap">
                    ...
                    <button type="button" class="toggle-eye" onclick="togglePassword('<%= txtConfirm.ClientID %>', this)"><i class="fas fa-eye-slash"></i></button>
                </div>
            </div>
    ...
    <script type="text/javascript">
        function togglePassword(inputId, btn) {
            ...
            if (btn && btn.firstElementChild) {
                ...
                btn.firstElementChild.className = nowVisible ? 'fas fa-eye' : 'fas fa-eye-slash';
            }
        }
    </script>
</body>
