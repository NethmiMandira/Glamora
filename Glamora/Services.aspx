...
<head runat="server">
        <!-- Ensure relative links resolve from application root so navbar links work when browsing folder-like URLs -->
    ...
    <form id="form1" runat="server">
        <div class="dashboard-wrapper">
            <div class="sidebar">
                <h2>Glamora</h2>
                <ul class="nav-list">
                    <li><a href="<%= ResolveUrl("~/Dashboard.aspx") %>"><i class="fas fa-chart-line"></i><span>Dashboard</span></a></li>
                    <li><a href="<%= ResolveUrl("~/ReportGenerating.aspx") %>"><i class="fas fa-file-alt"></i> <span>Reports</span></a></li>
                    <li id="liServices" runat="server" class="active"><a href="<%= ResolveUrl("~/Services.aspx") %>"><i class="fas fa-magic"></i><span>Services</span></a>
                        <ul class="sub-nav">
                            <li><a href="ServiceCategories.aspx"><i class="fas fa-th-large"></i><span>Categories</span></a></li>
                        </ul>
                    </li>
                    <li><a href="<%= ResolveUrl("~/AppointmentBooking.aspx") %>"><i class="fas fa-calendar-check"></i><span>Appointment Booking</span></a></li>
                    <li><a href="<%= ResolveUrl("~/AppointmentsList.aspx") %>"><i class="fas fa-clipboard-list"></i><span>Appointment Calender</span></a></li>
                    <li><a href="<%= ResolveUrl("~/Invoice.aspx") %>"><i class="fas fa-file-invoice"></i><span>Invoice</span></a></li>
                    <li><a href="<%= ResolveUrl("~/Employees.aspx") %>"><i class="fas fa-user-tie"></i><span>Employees</span></a></li>
                    <li><a href="<%= ResolveUrl("~/Customers.aspx") %>"><i class="fas fa-users"></i><span>Customers</span></a></li>
                    <li><a href="<%= ResolveUrl("~/Settings.aspx") %>"><i class="fas fa-sliders-h"></i><span>Settings</span></a></li>
                    <li class="logout">
