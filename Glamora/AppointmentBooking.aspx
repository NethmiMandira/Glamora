        ...
        <div class="dashboard-wrapper">
            <div class="sidebar">
                ...
                <ul class="nav-list">
                    ...
                    <li><a href="<%= ResolveUrl("~/Services.aspx") %>"><i class="fas fa-magic"></i><span>Services</span></a></li>
                    <li class="active"><a href="<%= ResolveUrl("~/AppointmentBooking.aspx") %>"><i class="fas fa-calendar-check"></i><span>Appointment Booking</span></a></li>
