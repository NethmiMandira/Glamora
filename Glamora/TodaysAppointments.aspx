...
<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TodaysAppointments.aspx.cs" Inherits="Glamora.TodaysAppointments" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Glamora | Today's Appointments</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* Button variants matching PendingToday (lighter gradients, white text) */
        ...
        .btn-invoice { background: linear-gradient(135deg, var(--accent-blue), var(--primary-color)); }
        .btn-invoice:hover { transform: translateY(-2px); }

        /* Ensure action buttons have white text for contrast */
        .btn-pay, .btn-pay.btn-edit, .btn-pay.btn-cancel, .btn-pay.btn-remove, .btn-pay.btn-invoice {
            color: #fff;
        }
    ...
    <form id="form1" runat="server">
        <div class="page">
            ...
            <div class="header-section">
                <h1 class="header">Today's Appointments</h1>
                    ...
                    <div class='<%# (bool)Eval("IsExpired") ? "card expired" : "card" %>'>
                        ...
                        <div class="card-body">
                            ...
                            <div class="inline-row">
                                ...
                                <span class='chip status <%# GetStatusClass(Eval("Status")) %>'><%# FormatStatus(Eval("Status")) %></span>
                            </div>
                        </div>
